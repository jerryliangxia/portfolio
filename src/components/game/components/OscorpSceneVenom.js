...
Command: npx gltfjsx@6.2.13 public/models/oscorp_scene_cables.glb 
*/
...
export function Model(props) {
  const { nodes, materials } = useGLTF("models/oscorp_scene_venom.glb");
  return (
    <group {...props} dispose={null}>
      ...
      />
      <mesh
        geometry={nodes.Base_Top.geometry}
        material={materials.Wood}
        position={[4.9, -1.326, -10.774]}
        rotation={[0, -0.548, 0]}
      />
      <mesh
        geometry={nodes.Fence_Back.geometry}
        material={materials.Wood}
        position={[4.9, -1.326, -10.774]}
        rotation={[0, -0.548, 0]}
      />
      <mesh
        geometry={nodes.Fence_Back_Bottom.geometry}
        material={materials.Wood}
        position={[4.9, -1.326, -10.774]}
        rotation={[0, -0.548, 0]}
      />
      ...
      <mesh
        geometry={nodes.Base_Bottom_Metal.geometry}
        material={materials["Darker Gray"]}
        position={[4.9, -2.395, -10.774]}
        rotation={[0, -0.548, 0]}
      />
      <mesh
        geometry={nodes.Insomniac_Exhaust_R.geometry}
        material={materials["Darker Gray"]}
        position={[5.116, -1.101, -8.834]}
        rotation={[Math.PI, 0, Math.PI]}
        scale={[-0.11, -0.008, -0.11]}
      />
      <mesh
        geometry={nodes.Insomniac_Exhaust_L.geometry}
        material={materials["Darker Gray"]}
        position={[4.449, -1.101, -8.834]}
        rotation={[Math.PI, 0, Math.PI]}
        scale={[-0.11, -0.008, -0.11]}
      />
      ...
      <mesh
        geometry={nodes.Insomniac_Wire_3.geometry}
        material={materials.Black}
        position={[5.127, -1.073, -11.1]}
        rotation={[-Math.PI, 0.499, 0]}
        scale={[-0.048, -0.014, -0.011]}
      />
      <mesh
        geometry={nodes.Insomniac_Wire_2.geometry}
        material={materials.Black}
        position={[4.763, -1.073, -11.284]}
        rotation={[0, -1.523, 0]}
        scale={[0.048, 0.014, 0.011]}
      />
      <mesh
        geometry={nodes.Insomniac_Wire_1.geometry}
        material={materials.Black}
        position={[6.667, -1.073, -9.542]}
        rotation={[-Math.PI, 0.499, 0]}
        scale={[-0.048, -0.014, -0.011]}
      />
      <mesh
        geometry={nodes.Insomniac_Wire_3001.geometry}
        material={materials.Black}
        position={[4.568, 0.964, -10.941]}
        rotation={[-2.761, -0.961, -1.215]}
        scale={[-0.048, -0.014, -0.011]}
      />
      <mesh
...
useGLTF.preload("models/oscorp_scene_venom.glb");
