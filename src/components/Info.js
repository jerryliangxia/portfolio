...
export const ThreeD = {
  ...
  parkerHead:
    "Original face model based off of Ben Jordan from the Remastered game (2020). Keen's FaceBuilder tool was used for the head sculpt, with minor adjustments using Blender's sculp tool. Blender's geometry nodes were used for the hair, and a specular material was used for the eyes, along with a normal map for the iris to create a sense of depth.",
